...
<div class="container flex flex-col items-center">
	<span class="text-xl font-bold mb-3">区: {{ $area->name }}</span>
  <div class="flex w-full mb-3 text-lg">
    <form class="flex w-full" action="{{ route('area.search', $area) }}" method="get" role="search">
      @csrf
  ...
  <div class="flex w-full">
    <div class="flex w-full space-x-3 m-2">
      <a href="{{ route('area.index') }}" class="">
        <i class="fas fa-map-signs fa-2x bg-yellow-900 text-white p-2 rounded-xl"></i>
      </a>
    </div>
